  ...
  return (
    <div>
        <div className='flex bg-login lg:bg-fit bg-cover bg-bottom justify-center items-center min-h-screen '>
            <div className='lg:w-5/12 xl:w-4/12 w-11/12 py-6 px-5 lg:px-10 bg-white'>
                ...
                <div className='pb-8 pt-3'>
                    <p className='text-gray-600 fw-600'>Forget password? fill in your details and instructions will be sent to you.</p>
                </div>
                <form>
                    <div>
