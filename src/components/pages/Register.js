                        ...
                        <form ref={el => (formRef = el)}>
                            <div className='lg:flex'>
                                ...
                                <div className='lg:w-6/12 lg:pl-6 mt-4 lg:mt-0'>
                                    ...
                                    <select name='sex' value={gender} className="w-full p-2 py-1 mt-2 rounded border border-gray-400" onChange={changeGender} required>
                            ...
                            <div className='lg:w-6/12 lg:pr-6 mt-4'>
                                ...
                                <input type="text" placeholder="Enter referral code (if any)" name='referrer_code' value={referrer} onChange={setReferrer} className="w-full py-1 p-2 mt-2 rounded border border-gray-400" />
                            </div>
                            <div className='flex items-start my-4'>
                                <input type="checkbox" className='mt-2 mr-3' name='agreement' checked value={agreement} onChange={verifyAgreement} required />
